...
miyemenu = Menu(root)
root.config(menu = miyemenu)

cust_options = Menu(miyemenu)
miyemenu.add_cascade(label='Customer', menu=cust_options)
cust_options.add_command(label='check in', command = testingfunction)
cust_options.add_command(label='reserve service', command = testingfunction)
cust_options.add_command(label='look up service', command = testingfunction)

cust_billing = Menu(miyemenu)
miyemenu.add_cascade(label='Billing', menu=cust_billing)
cust_billing.add_command(label='print bill', command = testingfunction)
